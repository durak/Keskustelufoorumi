...
//                System.out.println(viesti.getKayttaja().getId());
    ...
    private void uusiLanka() throws SQLException {
        ...
        daoManager.getLankaDao().insertNewInstance(uusiLanka);
        int maxId = daoManager.getLankaDao().getMaxId();
    ...
    private void kirjoitaViesti() throws SQLException {
        ...
        if (daoManager.getLankaDao().findOne(lanka.getId()) == null) {
            daoManager.getLankaDao().insertNewInstance(lanka);
        } else {
            daoManager.getLankaDao().updateInstance(lanka);
        }
        
        daoManager.getViestiDao().insertNewInstance(viesti);
